...
return array(
    'Cora\\Controllers\\Controller' => $baseDir . '/lib/controllers/Controller.php',
    'Cora\\Controllers\\PetrinetController' => $baseDir . '/lib/controllers/PetrinetController.php',
    'Cora\\Controllers\\SessionController' => $baseDir . '/lib/controllers/SessionController.php',
    'Cora\\Controllers\\UserController' => $baseDir . '/lib/controllers/UserController.php',
    'Cora\\Converters\\Converter' => $baseDir . '/lib/converters/Converter.php',
    'Cora\\Converters\\JsonToCoverabilityGraph' => $baseDir . '/lib/converters/JsonToCoverabilityGraph.php',
    'Cora\\Converters\\JsonToGraph' => $baseDir . '/lib/converters/JsonToGraph.php',
    'Cora\\Converters\\LolaToPetrinet' => $baseDir . '/lib/converters/LolaToPetrinet.php',
    'Cora\\Converters\\PetrinetToDot' => $baseDir . '/lib/converters/PetrinetToDot.php',
    'Cora\\Converters\\PetrinetToJson' => $baseDir . '/lib/converters/PetrinetToJson.php',
    'Cora\\Converters\\PetrinetTranslator' => $baseDir . '/lib/converters/PetrinetTranslator.php',
    'Cora\\Enumerators\\Enumerator' => $baseDir . '/lib/enumerators/Enumerator.php',
    'Cora\\Enumerators\\GraphSetType' => $baseDir . '/lib/enumerators/GraphSetType.php',
    'Cora\\Enumerators\\TrailingSlashOptions' => $baseDir . '/lib/enumerators/TrailingSlashOptions.php',
    'Cora\\ErrorHandlers\\Errorhandler' => $baseDir . '/lib/errorhandlers/ErrorHandler.php',
    'Cora\\ErrorHandlers\\JSONErrorHandler' => $baseDir . '/lib/errorhandlers/JsonErrorHandler.php',
    'Cora\\ErrorHandlers\\NotFoundHandler' => $baseDir . '/lib/errorhandlers/NotFoundHandler.php',
    'Cora\\ErrorHandlers\\PreDefinedErrorHandler' => $baseDir . '/lib/errorhandlers/ErrorHandler.php',
    'Cora\\Exceptions\\CoraException' => $baseDir . '/lib/exceptions/CoraException.php',
    'Cora\\Feedback\\Feedback' => $baseDir . '/lib/feedback/Feedback.php',
    'Cora\\Feedback\\FeedbackCode' => $baseDir . '/lib/feedback/FeedbackCodes.php',
    'Cora\\MiddleWare\\MiddleWare' => $baseDir . '/lib/middleware/MiddleWare.php',
    'Cora\\MiddleWare\\TrailingSlash' => $baseDir . '/lib/middleware/TrailingSlash.php',
    'Cora\\Models\\DatabaseModel' => $baseDir . '/lib/models/DatabaseModel.php',
    'Cora\\Models\\PetrinetModel' => $baseDir . '/lib/models/PetrinetModel.php',
    'Cora\\Models\\SessionModel' => $baseDir . '/lib/models/SessionModel.php',
    'Cora\\Models\\UserModel' => $baseDir . '/lib/models/UserModel.php',
    'Cora\\QueryBuilder' => $baseDir . '/lib/querybuilder/QueryBuilder.php',
    'Cora\\Search\\BreadthFirstSearch' => $baseDir . '/lib/search/BreadthFirstSearch.php',
    'Cora\\Search\\SearchNode' => $baseDir . '/lib/search/SearchNode.php',
    'Cora\\SystemCheckers\\CheckCoverabilityGraph' => $baseDir . '/lib/systemcheckers/CheckCoverabilityGraph.php',
    'Cora\\SystemCheckers\\CheckReachabilityGraph' => $baseDir . '/lib/systemcheckers/CheckReachabilityGraph.php',
    'Cora\\SystemCheckers\\ReachabilityTriple' => $baseDir . '/lib/systemcheckers/CheckReachabilityGraph.php',
    'Cora\\SystemCheckers\\SystemChecker' => $baseDir . '/lib/systemcheckers/Systemchecker.php',
    'Cora\\SystemCheckers\\VertexTransitionPair' => $baseDir . '/lib/systemcheckers/CheckReachabilityGraph.php',
    'Cora\\Systems\\CoverabilityMarking' => $baseDir . '/lib/systems/CoverabilityMarking.php',
    'Cora\\Systems\\Edge' => $baseDir . '/lib/systems/graphs/Edge.php',
    'Cora\\Systems\\Graph' => $baseDir . '/lib/systems/graphs/Graph.php',
    'Cora\\Systems\\IntegerTokenCount' => $baseDir . '/lib/systems/tokens/IntegerTokenCount.php',
    'Cora\\Systems\\Marking' => $baseDir . '/lib/systems/Marking.php',
    'Cora\\Systems\\OmegaTokenCount' => $baseDir . '/lib/systems/tokens/OmegaTokenCount.php',
    'Cora\\Systems\\Petrinet\\Flow' => $baseDir . '/lib/systems/petrinet/Flow.php',
    'Cora\\Systems\\Petrinet\\MarkingTransitionPair' => $baseDir . '/lib/systems/petrinet/Petrinet.php',
    'Cora\\Systems\\Petrinet\\Petrinet' => $baseDir . '/lib/systems/petrinet/Petrinet.php',
    'Cora\\Systems\\TokenCount' => $baseDir . '/lib/systems/tokens/TokenCount.php',
    'Cora\\Systems\\TokenCountFactory' => $baseDir . '/lib/systems/tokens/TokenCountFactory.php',
    'Cora\\Utils\\ArrayUtils' => $baseDir . '/lib/utilities/ArrayUtils.php',
    'Cora\\Utils\\DatabaseUtils' => $baseDir . '/lib/utilities/DatabaseUtils.php',
    'Cora\\Utils\\FileUploadUtils' => $baseDir . '/lib/utilities/FileUploadUtils.php',
    'Cora\\Utils\\FileUtils' => $baseDir . '/lib/utilities/FileUtils.php',
    'Cora\\Validator\\Validator' => $baseDir . '/lib/validator/Validator.php',
