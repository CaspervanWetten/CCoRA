...
return array(
    'Cozp\\Controllers\\Controller' => $baseDir . '/lib/controllers/Controller.php',
    'Cozp\\Controllers\\PetrinetController' => $baseDir . '/lib/controllers/PetrinetController.php',
    'Cozp\\Controllers\\SessionController' => $baseDir . '/lib/controllers/SessionController.php',
    'Cozp\\Controllers\\UserController' => $baseDir . '/lib/controllers/UserController.php',
    'Cozp\\Converters\\Converter' => $baseDir . '/lib/converters/Converter.php',
    'Cozp\\Converters\\JsonToCoverabilityGraph' => $baseDir . '/lib/converters/JsonToCoverabilityGraph.php',
    ...
    'Cozp\\Enumerators\\TrailingSlashOptions' => $baseDir . '/lib/enumerators/TrailingSlashOptions.php',
    'Cozp\\ErrorHandlers\\Errorhandler' => $baseDir . '/lib/errorhandlers/errorHandler.php',
    ...
    'Cozp\\MiddleWare\\MiddleWare' => $baseDir . '/lib/middleware/MiddleWare.php',
    'Cozp\\MiddleWare\\TrailingSlash' => $baseDir . '/lib/middleware/TrailingSlash.php',
    'Cozp\\Models\\Model' => $baseDir . '/lib/models/Model.php',
    'Cozp\\Models\\PetrinetModel' => $baseDir . '/lib/models/PetrinetModel.php',
    'Cozp\\Models\\UserModel' => $baseDir . '/lib/models/UserModel.php',
    'Cozp\\QueryBuilder\\QueryBuilder' => $baseDir . '/lib/querybuilder/QueryBuilder.php',
    'Cozp\\Search\\BreadthFirstSearch' => $baseDir . '/lib/search/BreadthFirstSearch.php',
    'Cozp\\Search\\SearchNode' => $baseDir . '/lib/search/SearchNode.php',
    'Cozp\\SystemCheckers\\CheckCoverabilityGraph' => $baseDir . '/lib/systemcheckers/CheckCoverabilityGraph.php',
    'Cozp\\SystemCheckers\\CheckReachabilityGraph' => $baseDir . '/lib/systemcheckers/CheckReachabilityGraph.php',
    'Cozp\\SystemCheckers\\ReachabilityTriple' => $baseDir . '/lib/systemcheckers/CheckReachabilityGraph.php',
    'Cozp\\SystemCheckers\\SystemChecker' => $baseDir . '/lib/systemcheckers/Systemchecker.php',
    'Cozp\\SystemCheckers\\VertexTransitionPair' => $baseDir . '/lib/systemcheckers/CheckReachabilityGraph.php',
    'Cozp\\Systems\\CoverabilityMarking' => $baseDir . '/lib/systems/CoverabilityMarking.php',
    'Cozp\\Systems\\Edge' => $baseDir . '/lib/systems/graphs/Edge.php',
    'Cozp\\Systems\\Graph' => $baseDir . '/lib/systems/graphs/Graph.php',
    'Cozp\\Systems\\IntegerTokenCount' => $baseDir . '/lib/systems/tokens/IntegerTokenCount.php',
    'Cozp\\Systems\\Marking' => $baseDir . '/lib/systems/Marking.php',
    'Cozp\\Systems\\OmegaTokenCount' => $baseDir . '/lib/systems/tokens/OmegaTokenCount.php',
    'Cozp\\Systems\\Petrinet\\Flow' => $baseDir . '/lib/systems/petrinet/Flow.php',
    'Cozp\\Systems\\Petrinet\\MarkingTransitionPair' => $baseDir . '/lib/systems/petrinet/Petrinet.php',
    'Cozp\\Systems\\Petrinet\\Petrinet' => $baseDir . '/lib/systems/petrinet/Petrinet.php',
    'Cozp\\Systems\\TokenCount' => $baseDir . '/lib/systems/tokens/TokenCount.php',
    'Cozp\\Systems\\TokenCountFactory' => $baseDir . '/lib/systems/tokens/TokenCountFactory.php',
    'Cozp\\Utils\\ArrayUtils' => $baseDir . '/lib/utilities/ArrayUtils.php',
    'Cozp\\Utils\\DatabaseUtils' => $baseDir . '/lib/utilities/DatabaseUtils.php',
    'Cozp\\Utils\\FileUploadUtils' => $baseDir . '/lib/utilities/FileUploadUtils.php',
    'Cozp\\Utils\\FileUtils' => $baseDir . '/lib/utilities/FileUtils.php',
    'Cozp\\Validator\\Validator' => $baseDir . '/lib/validator/Validator.php',
